...
namespace OsDsII.api.Migrations
{
    ...
    [Migration("20240610145734_MoreCorrectionsToFixRelationship")]
    partial class MoreCorrectionsToFixRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OsDsII.api.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("SendDate")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 6, 10, 11, 57, 34, 155, DateTimeKind.Unspecified).AddTicks(6779), new TimeSpan(0, -3, 0, 0, 0)));
            ...
            modelBuilder.Entity("OsDsII.api.Models.ServiceOrder", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("OpeningDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 6, 10, 11, 57, 34, 155, DateTimeKind.Unspecified).AddTicks(3234), new TimeSpan(0, -3, 0, 0, 0)));
