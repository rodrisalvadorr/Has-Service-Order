...
namespace OsDsII.api.Migrations
{
    ...
    [Migration("20240517185252_FixRelationship")]
            ...
            modelBuilder.Entity("OsDsII.api.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("SendDate")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 5, 17, 15, 52, 51, 111, DateTimeKind.Unspecified).AddTicks(7656), new TimeSpan(0, -3, 0, 0, 0)));
