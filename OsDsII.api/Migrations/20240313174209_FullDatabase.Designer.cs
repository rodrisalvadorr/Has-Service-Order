...
namespace OsDsII.api.Migrations
{
    ...
    [Migration("20240313174209_FullDatabase")]
            ...
            modelBuilder.Entity("OsDsII.api.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("SendDate")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 3, 13, 14, 42, 8, 866, DateTimeKind.Unspecified).AddTicks(9418), new TimeSpan(0, -3, 0, 0, 0)));
            ...
            modelBuilder.Entity("OsDsII.api.Models.ServiceOrder", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("OpeningDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 3, 13, 14, 42, 8, 866, DateTimeKind.Unspecified).AddTicks(1763), new TimeSpan(0, -3, 0, 0, 0)));
